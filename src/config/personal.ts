  ...
  projects: [
    {
      ...
      technologies: ['Git Kernel', 'C', 'Golang', 'Distributed Systems'],
      image: 'https://www.huawei.com/-/media/Images/Corporate/Logo/huawei-logo.svg',
      githubUrl: '',
      demoUrl: '',
    },
    {
      ...
      image: 'https://res-static.hc-cdn.cn/cloudbu-site/china/zh-cn/solution/img/cloud-logo.svg',
      githubUrl: '',
      demoUrl: {
    ...
    },
    {
      ...
      technologies: ['Git', 'Platform Architecture', 'Performance Optimization'],
      image: 'https://gitcode.com/favicon.ico',
      githubUrl: '',
