    ...
    <section id="experience" className="section-container bg-gray-50 dark:bg-gray-900/50">
      ...
      >
        ...
        <div className="relative pl-8">
          {/* Timeline line */}
          <div className="absolute left-2.5 top-0 bottom-0 w-0.5 bg-primary-light/20 dark:bg-primary-dark/20" />
          ...
          {personalInfo.experience.map((exp, index) => (
            ...
            >
              {/* Timeline dot */}
              <div className="absolute left-[-32px] w-5 h-5 rounded-full bg-primary-light dark:bg-primary-dark border-4 border-white dark:border-gray-900 z-10" />
              ...
              <div className="card">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-4">
                  ...
                  <div className="flex flex-col md:items-end">
                    <span className="text-sm font-medium bg-primary-light/10 dark:bg-primary-dark/10 text-primary-light dark:text-primary-dark px-3 py-1 rounded-full w-fit">
                      {exp.period}
                    </span>
